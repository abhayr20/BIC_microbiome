...
setwd("path_to_raw_data") # change path
...
tcga_clinical <- read_tsv("raw_data/TCGA-BIC-clinical.tsv")                      # clinical parameters 
tcga_meta     <- read.csv("raw_data/Metadata-TCGA-Kraken-17625-Samples.csv")     # metagenomic metadata, X is a unique patient sample
tcga_kraken   <- read.csv("raw_data/Kraken-TCGA-Raw-Data-17625-Samples.csv")     # metagenomic cnt_mxt
...
#Final check
alpha <- read.csv("/path_to_results/brca_alpha_div.csv", row.names = 1)
